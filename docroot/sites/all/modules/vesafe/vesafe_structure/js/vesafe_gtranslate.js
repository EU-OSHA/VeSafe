function vesafe_doGTranslate(lang_pair){
    ...
    var vesafe_language = lang_pair.value.split("|");
    if(vesafe_language[1] && languages[vesafe_language[1]]){
        setPiwikLanguage(languages[vesafe_language[1]]);
    }
}
